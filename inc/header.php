    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
         <li class="nav-item">
              <a class="nav-link" href="/Projects PHP Native/feedback/index.php">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/Projects PHP Native/feedback/feedback.php"
                >Feedback</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/Projects PHP Native/feedback/about.php"
                >About</a
              >
            </li>
        </ul>
